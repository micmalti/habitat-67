...
class SessionHandler:
    ...
    It has a [`test` method][beepop.check_in.moneybase.TradingAccount] that tells if a block matches a criterion,
    and a [`run` method][beepop.check_in.moneybase.TradingAccount] that processes it.
